...
| 회차   | 일시   | 내용                                  | 발표자  |              발표자료                    |
| -----  |:------:| :-------------------------------------|:-------:|:---------------------------------------- |
| 1  |11/24|(지각심리) 5. Perceiving Objects and Scenes | 박성영 |   |
|    |     |(CVPy) 5. Multiple View Geometry (1)            | 한태규 |   |
|    |     |(CVMetrics) 4: Local Feature Design Concepts, Classification, and Learning (1) |  김무성 |   |
|    |     |(DeepCV) Convolutional Neural Networks: architectures, convolution / pooling layers | 박경원  |  |
|    |     |(딥코딩) Tensorflow (1) - 설치 & 오버뷰 | 김무성  |  |
| 2  |12/8 |(지각심리) 6. Visual Attention | 송숙영  |   |
|    |     |(CVPy) 5. Multiple View Geometry (2)  | 한태규 |   |
...
|    |     |(CVPy)  5. Multiple View Geometry (3) | 한태규 |   |
|    |     |(CVMetrics) 4: Local Feature Design Concepts, Classification, and Learning (2) | 김무성  |   |
...
|    |     |(DeepCV) Beyond Image Classification: localization, detection, segmentation. 
